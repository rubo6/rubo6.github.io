...
| Zero third-party origins                          | fonts, icons, images     | Self-hosted via Fontsource and `public/`. Adding an origin requires an ADR.                                                                                                                                                                                                                                             |
...
- No analytics. If ever added, it must be cookieless and self-hosted or first-party-proxied, documented in an ADR.
